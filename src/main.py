...
VALID_AUTHOR_IDS = [
    "967275823407173632", "967275686798716928", "967275962762932244"
]
'''
async def on_ready():
...
def main():
  ...
  async def parse_sender(
    ...
    embed = discord.Embed(
        title=
        f"{username} has found {(ore_type.capitalize() + ' ' if ore_type != 'NORMAL' else '')}{ore_name} {'' if cave_type is None else f'(_{cave_type}_)'}",
        description=world,
        color=tier_color,
    )
